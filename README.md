...
| `enable_switch`                           | True     | string  |           | Entity ID of a switch/toggle helper that allows enabling/disabling the function. If not provided the app will be enabled as default.                                                                            |
